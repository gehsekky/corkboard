  ...
  return (
    <div className="max-w-sm w-80 mx-auto">
      <Form method="post">
        ...
        <button type="submit" name="submit" value="login" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">login</button>
        <div className="p-4 text-center"><Link to="/create_user">create new account</Link></div>
      </Form>
    </div>
  );
};
